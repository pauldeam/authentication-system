...
function authRedirectRestricted() {
        ...
        window.location="https://project2-paul225.c9users.io/AuthProj/public/index.html";
        firebase.auth().signOut();
    ...
    function authRedirect(){
        ...
        firebase.auth().onAuthStateChanged(firebaseUser=>{
            if(firebaseUser){
                ...
                console.log(user);
                window.location="https://project2-paul225.c9users.io/AuthProj/public/restrictedPage.html";
